 ...
 */
public class ForgotPasswordActivity extends SherlockActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mEmailSignInButton = (Button) findViewById(R.id.action_send);
        ...
        mFacebookButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(ForgotPasswordActivity.this, "Facebook Login Not Support Yet", Toast.LENGTH_LONG).show();
            }
        });
